...
var formElementWrapper = function (Component) {
    return function (props) {
        ...
        return (React.createElement("div", { className: wClassName.join(" ") },
            label && (React.createElement("label", { className: lClassName.join(" ") }, label)),
            React.createElement(Component, __assign({}, innerProps, { name: name, label: label, horizontal: horizontal })),
