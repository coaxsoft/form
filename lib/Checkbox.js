...
var Checkbox = function (props) {
    ...
    // classNames
    var classNames = ["coax-form--checkbox-el"];
    if (className)
        classNames.push(className);
    if (errors[name])
        classNames.push("coax-form--checkbox-el__error");
    return (React.createElement("div", { className: "coax-form--checkbox-wrapper" },
        React.createElement("input", { id: name, className: classNames.join(" "), name: name, ref: register, type: "checkbox" }),
        React.createElement("label", { className: "coax-form--checkbox-label", htmlFor: name }, props.children || null)));
};
